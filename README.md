...
I'm rebuilding cryptopriceman.com in react and adding new features once I bring the site up to where it is currently.

See below code for boiler plate readme from create react app
